...
```bash
curl -fsSL https://git.harivan.sh/harivansh-afk/claude-continual-learning/raw/branch/main/install.sh | bash
```

Or clone and install manually:

```bash
git clone https://git.harivan.sh/harivansh-afk/claude-continual-learning.git
